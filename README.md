...
- Now deprecated, Inter-App Audio's ability to send MIDI via the same IPC it uses for audio may have previously provided a suitable realtime alternative to CoreMIDI for registered application pass through on iOS devices. I will investigate resurrecting.[^5]
